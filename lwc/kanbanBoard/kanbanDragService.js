...
export class KanbanDragService {
  ...
  static initializeDragAndDrop(boardElement, callbacks = {}) {
    ...
    console.log("KanbanDragService: Drag and drop initialized");
  }
  ...
  static handleDragStart(event) {
    ...
    console.log("KanbanDragService: Drag started for card:", cardId);
  }
  ...
  static handleDrop(event) {
    ...
    console.log("KanbanDragService: Card dropped:", cardId);
  }
  ...
  static handleDragEnd(event) {
    ...
    console.log("KanbanDragService: Drag ended for card:", card.dataset.id);
  }
  ...
  static disableDragAndDrop(boardElement) {
    ...
    console.log("KanbanDragService: Drag and drop disabled");
  }
