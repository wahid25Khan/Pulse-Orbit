...
export class KanbanPerformanceService {
  ...
  static debounce(func, wait) {
    ...
    return function executedFunction(...args) {
      ...
      clearTimeout(timeout);
      // Use Promise.resolve().then() instead of setTimeout for LWC compatibility
      timeout = Promise.resolve().then(() => {
  ...
  static throttle(func, limit) {
    ...
    return function (...args) {
      if (!inThrottle) {
        ...
        inThrottle = true;
        // Use Promise-based timing for LWC compatibility
        Promise.resolve().then(() => {
          ...
          const resetThrottle = () => {
            if (Date.now() - start >= limit) {
              ...
              Promise.resolve().then(resetThrottle);
            }
          };
          resetThrottle();
        });
